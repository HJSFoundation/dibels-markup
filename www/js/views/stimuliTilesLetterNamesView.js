App.Views.StimuliTilesLetterNames = Backbone.View.extend({
  ...
  render: function() {
    ...
    var that = this;
    var stimuli = App.stimuli.where({user_id: App.selectedStudent.get('user_id'), reading_stage: App.selectedStudent.get('reading_stage'), skill: App.Config.skill.letterNames});
