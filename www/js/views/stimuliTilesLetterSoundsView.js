App.Views.StimuliTilesLetterSounds = Backbone.View.extend({
  ...
  render: function() {
    ...
    var that = this;
    var stimuli = App.stimuli.where({studentId: App.selectedStudent.get('id'), reading_stage: App.selectedStudent.get('reading_stage'), skill: App.Config.skill.letterSounds});
