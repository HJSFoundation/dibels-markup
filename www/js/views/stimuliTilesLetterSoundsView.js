App.Views.StimuliTilesLetterSounds = Backbone.View.extend({
  ...
  listen: function() {
    this.listenTo(App.Dispatcher, "SkillChangeRequested:" + App.Config.skill.letterSounds, this.handleSkillChangeRequest);
  ...
  render: function() {
    ...
    var that = this;
    var stimuli = App.stimuli.where({ user_id: App.selectedStudent.get('id'), reading_stage: App.selectedStudent.displayedReadingStage(), skill: App.Config.skill.letterSounds });
