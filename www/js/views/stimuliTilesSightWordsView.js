App.Views.StimuliTilesSightWords = Backbone.View.extend({
  ...
  render: function() {
    ...
    var that = this;
    var stimuli = App.stimuli.where({studentId:App.selectedStudent.get('id'), readingStage: App.selectedStudent.get('readingStage'), skill: App.Config.skill.sightWords});
