App.Views.StimuliTilesCVts = Backbone.View.extend({
  ...
  render: function() {
    ...
    var onsetStimuli = App.stimuli.where({studentId:App.selectedStudent.get('id'), reading_stage: App.selectedStudent.get('reading_stage'), skill: App.Config.skill.cvts, subSkill: App.Config.skill.onsets});
    ...
    var rimeStimuli = App.stimuli.where({studentId:App.selectedStudent.get('id'), reading_stage: App.selectedStudent.get('reading_stage'), skill: App.Config.skill.cvts, subSkill: App.Config.skill.rimes});
