App.Views.StimuliTilesCVts = Backbone.View.extend({
  ...
  render: function() {
    ...
    var onsetStimuli = App.stimuli.where({user_id:App.selectedStudent.get('user_id'), reading_stage: App.selectedStudent.get('reading_stage'), skill: App.Config.skill.cvts, subSkill: App.Config.skill.onsets});
    ...
    var rimeStimuli = App.stimuli.where({user_id:App.selectedStudent.get('user_id'), reading_stage: App.selectedStudent.get('reading_stage'), skill: App.Config.skill.cvts, subSkill: App.Config.skill.rimes});
