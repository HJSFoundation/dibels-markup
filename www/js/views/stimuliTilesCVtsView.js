App.Views.StimuliTilesCVts = Backbone.View.extend({
  ...
  render: function() {
    ...
    var onsetStimuli = App.stimuli.where({studentId:App.selectedStudent.get('id'), readingStage: App.selectedStudent.get('readingStage'), skill: App.Config.skill.cvts, subSkill: App.Config.skill.onsets});
    ...
    var rimeStimuli = App.stimuli.where({studentId:App.selectedStudent.get('id'), readingStage: App.selectedStudent.get('readingStage'), skill: App.Config.skill.cvts, subSkill: App.Config.skill.rimes});
