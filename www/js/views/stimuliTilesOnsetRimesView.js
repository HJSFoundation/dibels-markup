App.Views.StimuliTilesOnsetRimes = Backbone.View.extend({
  ...
  render: function() {
    ...
    var onsetStimuli = App.stimuli.where({user_id:App.selectedStudent.get('user_id'), reading_stage: App.selectedStudent.get('reading_stage'), skill: App.Config.skill.onsetRimes, subSkill: App.Config.skill.onsets});
    ...
    var rimeStimuli = App.stimuli.where({user_id:App.selectedStudent.get('user_id'), reading_stage: App.selectedStudent.get('reading_stage'), skill: App.Config.skill.onsetRimes, subSkill: App.Config.skill.rimes});
