  ...
  listen: function() {
    this.listenTo(App.Dispatcher, "SkillChangeRequested:" + App.Config.skill.onsetRimes, this.handleSkillChangeRequest);
  ...
  render: function() {
    ...
    var onsetStimuli = App.stimuli.where({ user_id:App.selectedStudent.get('id'), reading_stage: App.selectedStudent.displayedReadingStage(), skill: App.Config.skill.onsetRimes, sub_skill: App.Config.skill.onsets });
    ...
    var rimeStimuli = App.stimuli.where({ user_id:App.selectedStudent.get('id'), reading_stage: App.selectedStudent.displayedReadingStage(), skill: App.Config.skill.onsetRimes, sub_skill: App.Config.skill.rimes });
