App.Views.StimuliTilesOnsetRimes = Backbone.View.extend({
  ...
  render: function() {
    ...
    var onsetStimuli = App.stimuli.where({studentId:App.selectedStudent.get('id'), reading_stage: App.selectedStudent.get('reading_stage'), skill: App.Config.skill.onsetRimes, subSkill: App.Config.skill.onsets});
    ...
    var rimeStimuli = App.stimuli.where({studentId:App.selectedStudent.get('id'), reading_stage: App.selectedStudent.get('reading_stage'), skill: App.Config.skill.onsetRimes, subSkill: App.Config.skill.rimes});
