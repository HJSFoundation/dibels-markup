...
this["App"]["templates"]["conferenceManagementSingle"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"container container--overlay animated slideInUp\">\n  <button class=\"button button--close button--close--edit-student js-closeOverlayButton\">\n    <svg class=\"icon-close--overlay icon-close\"><use xlink:href=\"#icon-close\"></use></svg>\n    <svg class=\"icon-close--overlay icon-close-filled st-hidden\"><use xlink:href=\"#icon-close-filled\"></use></svg>\n </button>\n  <div class=\"overlay__menu\">\n    <a href=\"#\" class=\"menu--tab menu--tab--edit-student js-cancelAddStudent\" style=\"left: "
