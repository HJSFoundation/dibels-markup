describe('App.Views.StimuliTilesLeveledTexts', function() {
  ...
  describe("#listen", function() {
    it("listens for the SkillChangeRequested:LeveledTexts event", function() {
      ...
      subject.listen();
      expect(subject.listenTo).to.have.been.calledWith(App.Dispatcher, "SkillChangeRequested:LeveledTexts", subject.handleSkillChangeRequest);
    });
  ...
  describe("handlers", function() {
    ...
    it("#handleStudentChangeRequest", function() {
      ...
      sinon.spy(subject, "render");
      App.selectedSkill = App.Config.skill.leveledTexts;
