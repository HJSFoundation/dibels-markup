describe('App.Views.StimuliTilesOnsetRimes', function() {
  var subject;
  var xhr;
  var requests;
  ...
  beforeEach(function() {
    ...
    App.selectedStudent = new App.Models.Student({ id: 1, reading_stage: 4, displayedReadingStage: 4 });
  ...
  describe("#listen", function() {
    it("listens for the SkillChangeRequested:OnsetRimes event", function() {
      ...
      subject.listen();
      expect(subject.listenTo).to.have.been.calledWith(App.Dispatcher, "SkillChangeRequested:" + App.Config.skill.onsetRimes, subject.handleSkillChangeRequest);
    });
