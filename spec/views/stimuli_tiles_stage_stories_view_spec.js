describe('App.Views.StimuliTilesStageStories', function() {
  ...
  describe("#listen", function() {
    it("listens for the SkillChangeRequested:StageStories event", function() {
      ...
      subject.listen();
      expect(subject.listenTo).to.have.been.calledWith(App.Dispatcher, "SkillChangeRequested:"+App.Config.skill.stageStories, subject.handleSkillChangeRequest);
    });

    it("listens for the SkillChangeRequested:LeveledTexts event", function() {
      sinon.spy(subject, "listenTo");
      subject.listen();
      expect(subject.listenTo).to.have.been.calledWith(App.Dispatcher, "SkillChangeRequested:"+App.Config.skill.leveledTexts, subject.handleSkillReplaceRequest);
    });
